...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <div className="bg-[#E30613] px-4 py-2 text-center text-sm font-semibold text-white">
        🚚 {t.delivery} • 🔒 {t.secure} • ⭐{" "}
        {t.quality}
      </div>
...
>
  ...
  />
            ...
            <div className="hidden flex-1 md:block">
              ...
              <div className="relative mx-auto max-w-2xl">
                ...
                <input
                  ...
                  className="w-full rounded-full border border-slate-200 bg-slate-50 py-3 pl-11 pr-5 outline-none transition focus:border-[#E30613] focus:bg-white"
                />
            ...
            <a
              href="/cart"
              className="relative flex items-center gap-2 rounded-xl border border-slate-200 px-4 py-2.5 font-bold text-slate-800 transition hover:border-[#E30613] hover:bg-red-50"
            >
              🛒
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mb-8 flex items-end justify-between">
            ...
            <button
              ...
              className="hidden rounded-xl border border-slate-200 px-5 py-3 text-sm font-black text-slate-700 transition hover:border-[#E30613] hover:bg-red-50 md:block"
            >
              {t.viewAll} →
            </button>
  ...
  return (
    <article className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      >
        ...
        {discount > 0 && (
          <span className="absolute left-3 top-3 rounded-full bg-[#E30613] px-3 py-1.5 text-xs font-black text-white shadow-md">
            -{discount}%
          </span>
        )}
      ...
      <div className="p-4">
        ...
        <a
          href={`/product/${product.id}`}
          className="mt-2 block min-h-12 line-clamp-2 text-base font-black leading-6 text-slate-900 transition hover:text-[#E30613]"
        >
          {product.name}
        </a>
        ...
        <button
          ...
          className="mt-4 w-full rounded-xl bg-[#E30613] px-4 py-3 text-sm font-black text-white shadow-sm transition-all duration-200 hover:bg-[#B80510] hover:shadow-md active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-slate-300 disabled:text-slate-500"
        >
